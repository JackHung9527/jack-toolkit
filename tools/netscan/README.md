# 網路掃描器 (Network Scanner)

純 Python 3 + tkinter，無第三方依賴。仿 MobaXterm 的三個工具：

1. **IP Range Scan** — 對一段 IPv4（如 `192.168.1.1` → `254`）做 ping sweep + 常見埠（SSH / RDP / VNC / FTP / Telnet / Rlogin / HTTP / HTTPS）探測
