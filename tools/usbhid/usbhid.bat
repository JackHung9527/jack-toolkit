@echo off
rem USB-HID tester launcher: prefer pythonw (no console window).
rem If startup fails, main.py's global excepthook writes usbhid_error.log
rem and pops a messagebox with the reason (e.g. missing hidapi).
cd /d "%~dp0"
